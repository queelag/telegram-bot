...
import { PRIVATE_CHAT_ID, SUPER_GROUP_CHAT_ID } from '../../vitest/constants'
...
describe('Restrict Requests', () => {
  it.skip('restricts a chat member', async () => {
    ...
    restrict = await restrictChatMember({ chat_id: SUPER_GROUP_CHAT_ID, permissions: {}, user_id: PRIVATE_CHAT_ID })
