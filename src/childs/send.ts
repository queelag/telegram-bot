...
class Send extends Child {
  async message(chat: number, text: string, parameters?: SendMessage): Promise<Message | Error> {
  ...
  async html(chat: number, text: string, parameters?: SendMessage): Promise<Message | Error> {
  ...
  async buttons(chat: number, text: string, buttons: InlineKeyboardButton[], parameters?: SendMessage): Promise<Message | Error> {
  ...
  async prompt(chat: number, text: string, parameters?: SendMessage): Promise<Message | Error> {
    return this.message(chat, text, {
      reply_markup: {
        force_reply: true,
        selective: true
  ...
  async card(chat: number, title: string, description: string, sticker?: Buffer, parameters?: SendMessage): Promise<Message | Error> {
  ...
  async photo(chat: number, photo: Buffer, parameters?: SendPhoto): Promise<Message | Error> {
    return this.file<SendPhoto, Message>(chat, photo, 'photo', parameters)
  }

  async audio(chat: number, audio: Buffer, parameters?: SendAudio): Promise<Message | Error> {
    return this.file<SendAudio, Message>(chat, audio, 'audio', parameters)
  }

  async document(chat: number, document: Buffer, parameters?: SendDocument): Promise<Message | Error> {
    return this.file<SendDocument, Message>(chat, document, 'document', parameters)
  }

  async video(chat: number, video: Buffer, parameters?: SendVideo): Promise<Message | Error> {
    return this.file<SendVideo, Message>(chat, video, 'video', parameters)
  }

  async animation(chat: number, animation: Buffer, parameters?: SendAnimation): Promise<Message | Error> {
    return this.file<SendAnimation, Message>(chat, animation, 'animation', parameters)
  }

  async voice(chat: number, voice: Buffer, parameters?: SendVoice): Promise<Message | Error> {
    return this.file<SendVoice, Message>(chat, voice, 'voice', parameters)
  }

  async videoNote(chat: number, videoNote: Buffer, parameters?: SendVideoNote): Promise<Message | Error> {
    return this.file<SendVideoNote, Message>(chat, videoNote, 'video_note', parameters)
  }

  async mediaGroup(chat: number, media: (InputMediaPhoto | InputMediaVideo)[], parameters?: SendMediaGroup): Promise<Message | Error> {
    return this.telegram.api.post<SendMediaGroup, Message>('sendMediaGroup', { chat_id: chat, media: media, ...parameters })
  }

  async location(chat: number, latitude: number, longitude: number, parameters?: SendLocation): Promise<Message | Error> {
  ...
  async venue(chat: number, latitude: number, longitude: number, title: string, address: string, parameters?: SendVenue): Promise<Message | Error> {
  ...
  async contact(chat: number, phoneNumber: number, firstName: string, parameters?: SendContact): Promise<Message | Error> {
  ...
  async poll(chat: number, question: string, options: string[], parameters?: SendPoll): Promise<Message | Error> {
    return this.telegram.api.post<SendPoll, Message>('sendPoll', { chat_id: chat, question: question, options: options, ...parameters })
  }

  async dice(chat: number, parameters?: SendDice): Promise<Message | Error> {
  ...
  async sticker(chat: number, sticker: Buffer, parameters?: SendSticker): Promise<Message | Error> {
  ...
  async game(chat: number, gameShortName: string, parameters?: SendGame): Promise<Message | Error> {
